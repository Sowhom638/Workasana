...
function TeamDetails() {
    ...
    const { data: team, loading: teamLoading, error: teamError } = useFetch(`${import.meta.env.VITE_BACKEND_URL}/teams/${teamId}`);
    ...
    let filteredTasks = [];
    if (tasks?.tasks) {
        filteredTasks = tasks.tasks.filter((task)=> task.team?._id === teamId).filter(task => {
            ...
            <div className="container mt-4">
                ...
                <div className="card shadow-sm border rounded-3">
                    <div className="card-header bg-white text-center py-3">
                        <h5 className="mb-0 fw-bold text-primary text-center">{team?.team?.name}</h5>
                    </div>
                        ...
                        <div className="row g-0">
                            ...
                            <div className="col-md-3 border-end bg-light">
                                <div className="p-3">
                                    ...
                                    <Link to={`/teams`} className="text-dark text-decoration-none d-block p-2 rounded hover-bg">
                            ...
                            <div className="col-md-9 p-4">
                                ...
                                <Link to={`/createTask/${teamId}`} className="btn btn-primary">
                                    + Add New Task
                                </Link>
                                <hr />
                                <div className="mb-4">
