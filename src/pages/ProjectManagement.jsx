                    ...
                    <div className="glass-panel p-3 p-md-4 mt-4 animate-in">
                        ...
                        <div className="card-header bg-transparent border-0 text-center pb-3">
                            <h4 className="mb-0 fw-bold" style={{ 
                                ...
                                {projectLoading ? <span className="loading-skeleton rounded-pill" style={{ width: '180px', display: 'inline-block' }}></span> : project?.project?.name || 'Project Details'}
                            </h4>
                            <p className="text-muted mb-0 mt-1 fs-6">Track progress, filter tasks, and manage assignments</p>
                        </div>
                        ...
                        <div className="card-body p-0">
                            <div className="row g-3 g-md-4">
                                ...
                                <div className="col-lg-9">
                                    ...
                                    {/* Task List */}
                                    <h6 className="fw-bold text-secondary mb-3 small text-uppercase">Task List</h6>
                                                    ...
                                                    <div className="d-flex justify-content-between align-items-start">
                                                        ...
                                                        <div className="text-end">
                                                            {task.owners?.map((owner) => (
                                                                <span key={owner._id} className="d-block small text-muted">{owner.name}</span>
                                                            ))}
                                    ...
                                    {/* CTA Button */}
                                    <Link to={`/createTask/${projectId}`} className="btn gradient-btn rounded-pill px-5 py-3 fw-semibold d-inline-flex align-items-center gap-2">
                                        <span className="fs-5">+</span> Add New Task
                                    </Link>
                                </div>
                            </div>
                        </div>
